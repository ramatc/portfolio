  ...
  return (
    <html lang="es">
      <body className={`${onest.className} relative`}>
        <div className="absolute top-0 bottom-0 z-[-2] min-h-screen w-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_50%,rgba(120,119,198,0.35),rgba(255,255,255,0))]"></div>
        <Header />
        {children}
        <Footer />
      </body>
